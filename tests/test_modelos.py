from app.modelos import Director, DAO_CSV_Director, Pelicula, DAO_CSV_Pelicula, Genero, DAO_CSV_Genero, DAO_SQLite, DAO_SQLite_Director
...
def test_dao_directores_sqlite_traer_todos():
    dao = DAO_SQLite_Director("data\movies.sqlite")
